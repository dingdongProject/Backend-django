    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateField(default=datetime.date(2020, 11, 15))),
                ('updated_at', models.DateField(default=datetime.date(2020, 11, 15))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateJoined', models.DateField(default=datetime.date(2020, 11, 15))),
                ('circle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='circle.circle')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='circle.duser')),
            ],
        ),
